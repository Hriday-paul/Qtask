...
export default function Footer() {
    return (
        <footer className="">
            <div className="bg-[#202430] pt-16 lg:pt-20 font-epilogue">
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 sm:px-[18px] md:flex-row md:px-10">
                    ...
                    <div className="border-t border-gray-700 mt-20 py-8 flex flex-row justify-between items-center">
                        <p className="font-epilogue text-sm font-normal text-gray-400">{new Date().getFullYear()} @ QuickHire. All right reserved.</p>
